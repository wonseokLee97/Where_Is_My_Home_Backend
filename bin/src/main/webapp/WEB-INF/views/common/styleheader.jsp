...
<div id="wrapper">
	...
	<ul
		...
		<a
			...
			href="${root}/index.jsp"> <!-- <div class="sidebar-brand-icon rotate-n-15">
		...
		<li class="nav-item"><a class="nav-link"
			onclick="location.href='${root}/home?act=mvapt'"> <i
				class="fas fa-fw fa-table"></i> <span>아파트별 상세 검색</span></a></li>

		<li class="nav-item"><a class="nav-link"
			onclick="location.href='${root}/home?act=mvnearsearch'">
				<i class="fas fa-fw fa-table"></i> <span>지역 주변 검색</span>
		</a></li>
