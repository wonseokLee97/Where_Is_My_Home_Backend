	...
	<%@ include file="/WEB-INF/views/common/header.jsp" %>
		...
		<script>
			...
			function loadTable(pgno) {
				...
				fetch('adlist?aptcode=' + ${home.aptCode} + "&pgno=" + pgno + "&year=" + year + "&month=" + month, {
					method: 'get',
					headers: {
					...
					.then(json => {
						console.log(json);
						let homes = json['list'];
						let tbody = document.querySelector(".home-list");
						tbody.innerHTML = "";
			...
			function createHTMLRow(home) {
				return '<tr class="text-center" onclick="#"><td>' 
